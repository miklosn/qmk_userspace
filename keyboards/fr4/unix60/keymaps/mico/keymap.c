...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_60_hhkb(
        ...
        KC_LSFT,          KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSFT, MO(1),
                 KC_LALT, KC_LGUI,                            LT(1, KC_SPC),                                      KC_RGUI, KC_RALT
    ),

    [1] = LAYOUT_60_hhkb(
        KC_TILD,       KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F10,  KC_F11,  _______, _______,
        LT(2, KC_TAB), KC_BRID, KC_BRIU, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
    ...
    [2] = LAYOUT_60_hhkb(
        KC_TILD,       KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F10,  KC_F11,  _______, _______,
        LT(2, KC_TAB), KC_BRID, KC_BRIU, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
        _______,       KC_MUTE, KC_VOLD, KC_VOLU, _______, _______, KC_HOME, KC_PGDN, KC_PGUP  , KC_END, _______, _______,          _______,
        _______,                _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
                 _______, _______,                            _______,                                     _______, _______
    )
 } ;
